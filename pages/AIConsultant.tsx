...
const AIConsultant: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-[110]">
      {isOpen ? (
        <div className="w-[calc(100vw-32px)] sm:w-80 md:w-96 bg-white dark:bg-card-dark rounded-2xl shadow-2xl border border-border-light dark:border-border-dark flex flex-col h-[500px] max-h-[70vh] overflow-hidden animate-in slide-in-from-bottom-4 duration-300">
        ...
        >
          ...
          <div className="absolute -top-1 -right-1 w-4 h-4 bg-emerald-500 border-2 border-white dark:border-background-dark rounded-full"></div>
        </button>
      )}
    </div>
  );
